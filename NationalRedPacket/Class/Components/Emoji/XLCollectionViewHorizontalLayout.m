//
//  XLCollectionViewHorizontalLayout.m
//  LYInputView
//
...
@interface XLCollectionViewHorizontalLayout()
@property (nonatomic, copy) NSMutableDictionary *sectionDic;
@property (strong, nonatomic) NSMutableArray *allAttributes;
@end

@implementation XLCollectionViewHorizontalLayout
...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)attributes
{
    ...
    attributes.frame = CGRectMake(adaptWidth750(11.5*2)+xCellOffset, adaptHeight1334(20*2)+yCellOffset, itemW, itemH);
}
