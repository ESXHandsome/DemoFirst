...
@interface XLClipViewController ()

@end

@implementation XLClipViewController
...
-(void)CreatUI
{
    ...
    UIBarButtonItem *barButton = [[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStylePlain target:self action:@selector(clipBtnSelected:)];
    barButton.tintColor = GetColor(COLORFB3958);
...
{
    CGFloat width= _imageView.frame.size.width;
    CGFloat rationScale = (width /_image.size.width)/_image.scale;
