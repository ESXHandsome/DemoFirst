...
@interface NIMSessionListViewController ()<NewsButtonContentViewDelegate>
...
- (void)setUpUI {
    ...
    XLSessionButtonContentView *topItemView = [[XLSessionButtonContentView alloc] init];
    ...
    [self.tableView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(topItemView.mas_bottom).mas_offset(adaptHeight1334(20));
...
#pragma mark - XLSessionContentViewDelegate
- (void)newsButtonContentViewButtonClicked:(NSInteger)tag {
    switch (tag) {
            case 0:
            [self showViewController:[XLSessionFansViewController new] sender:nil];
            break;
            case 1:
            ...
            break;
            case 3:
            [self showViewController:[XLSessionVisitorViewController new] sender:nil];
            break;
        default:
            break;
    }
