...
extern NSString *const NIMKitEventNameTapRedPacket;
extern NSString *const NIMKitEventNameTapGroupInvite;
extern NSString *const NIMKitEventNameTapIncomeNotice;
extern NSString *const NIMKitEventNameTapRedPacketTip;
extern NSString *const NIMKitEventNameTapActivityLink;
