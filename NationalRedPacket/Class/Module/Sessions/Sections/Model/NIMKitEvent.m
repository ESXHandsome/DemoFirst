...
NSString *const NIMKitEventNameTapRedPacket     = @"NIMKitEventNameTapRedPacket";
NSString *const NIMKitEventNameTapGroupInvite   = @"NIMKitEventNameTapGroupInvite";
NSString *const NIMKitEventNameTapIncomeNotice   = @"NIMKitEventNameTapIncomeNotice";
NSString *const NIMKitEventNameTapRedPacketTip     = @"NIMKitEventNameTapRedPacketTip";
NSString *const NIMKitEventNameTapActivityLink   = @"NIMKitEventNameTapActivityLink";
