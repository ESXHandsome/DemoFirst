...
static XLRouterArgumentKey * const XLRouterArgumentSessionKey = @"XLRouterArgumentSessionKey";

@interface NIMSessionViewController : UIViewController<NIMSessionInteractorDelegate,NIMInputActionDelegate,NIMMessageCellDelegate,NIMChatManagerDelegate,NIMConversationManagerDelegate, XLRoutableProtocol>
