...
+ (NIMMessage *)msgWithRedPacketLuckyId:(NSString *)luckyId content:(NSString *)content luckyTip:(NSString *)luckyTip {
    ...
    XLRedPacketAttachment *attachment = [XLRedPacketAttachment new];
    attachment.luckyid = luckyId;
    attachment.content = content;
    attachment.customMessageType = CustomMessageTypeRedPacket;
    attachment.status = RedPacketStatusNormal;
    attachment.tip = luckyTip ?: @"[神段子红包]恭喜发财，大吉大利";
