 ...
 *  红包消息设置
 */
@property (nonatomic, strong) NIMKitSetting *redPacketSetting;

/**
 *  红包提示消息设置
 */
@property (nonatomic, strong) NIMKitSetting *redPacketTipSetting;

/**
 *  群链接消息设置
 */
@property (nonatomic, strong) NIMKitSetting *groupInviteSetting;

/**
 *  到账通知消息设置
 */
@property (nonatomic, strong) NIMKitSetting *incomeNoticeSetting;

/**
 *  大图消息设置
 */
@property (nonatomic, strong) NIMKitSetting *bigPictureSetting;

/**
 *  图文消息设置
 */
@property (nonatomic, strong) NIMKitSetting *textAndPictureSetting;

/**
 *  组图消息设置
 */
@property (nonatomic, strong) NIMKitSetting *groupPicturesSetting;

/**
 *  小应用消息设置
 */
@property (nonatomic, strong) NIMKitSetting *miniApplicationSetting;
