...
- (void)coinTouchAction:(userViewHeadView *)view;
- (void)changeTouchAction:(userViewHeadView *)view;
- (void)invitedTouchAction:(userViewHeadView *)view;
...
@property (strong, nonatomic) UILabel *myGoldCoin;
@property (strong, nonatomic) UILabel *myChange;
@property (strong, nonatomic) UILabel *invitedIncome;
