//
//  XLHomeImageFeedListViewController.m
//  NationalRedPacket
//
...
@interface XLHomeImageFeedListViewController ()

@end

@implementation XLHomeImageFeedListViewController
...
- (void)configureViewModel {
    self.viewModel = [XLHomeImageFeedListViewModel new];
}
