...
@property (strong, nonatomic) NSString *cardTpID;
@property (strong, nonatomic) NSString *signType;
@property (strong, nonatomic) NSString *cardSign;
@property (assign, nonatomic) UInt32 timeStamp;
...
@property (strong, nonatomic) NSArray* cardAry;
@end
...
@property (strong, nonatomic) NSString *webpageUrl; //低版本网页链接

@property (strong, nonatomic) NSString *userName;   //小程序username

@property (strong, nonatomic) NSString *path;       //小程序页面的路径

@property (strong, nonatomic) NSData *hdImageData;   // 小程序新版本的预览图 128k

@property (assign, nonatomic) BOOL withShareTicket;   //是否使用带 shareTicket 的转发
...
@property (strong, nonatomic) NSString *userName;   //拉起的小程序的username
@property (strong, nonatomic) NSString *path;       //拉起小程序页面的路径，不填默认拉起小程序首页
